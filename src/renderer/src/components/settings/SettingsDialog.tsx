 ...
 * far it reaches.
 */
function InsecureCertificates(): React.JSX.Element {
 ...
 * navigation in here: a sidebar with two entries is a promise about a third.
 * The theme lives in the toolbar, where it is one click rather than three.
 *
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Where screenshots go, what they look like, and what the device views will put up with.
          </DialogDescription>
        </DialogHeader>
